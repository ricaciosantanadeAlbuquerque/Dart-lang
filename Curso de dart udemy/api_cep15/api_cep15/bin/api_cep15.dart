...
Future<void> main() async {
  try {
    await buscarCep(cep: entradaDados());
...
String entradaDados() {
  ...
  if (entrada == null || entrada.isEmpty) {
    throw FormatException('O CEP não pode ser vazion');
  }

  if (entrada.length != 8) {
    throw FormatException('O CEP deve conter 8 números');
  }

  if (int.tryParse(entrada) == null) {
    throw FormatException('O Deve conter apenas números');
  }
