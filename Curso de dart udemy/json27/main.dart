...
''';
  ...
  conversaoJsonObjeto(jsondata: jsonData);
}

void conversaoJsonObjeto({required String jsondata}) {
  //? DECODE
  ...
  print('Objeto ${pessoa.bens.veiculos[0].multas[0].descrisao}');

  print('Pai: ${pessoa.parentes.pai}, mae: ${pessoa.parentes.mae}');

  pessoa.tarefas.forEach((e) {
    print('Tarefas ${e}');
  });
}
