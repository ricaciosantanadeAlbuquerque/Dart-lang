...
class Cao extends Mamifero {
  ...
  Cao({required this.nome, required this.raca, required String? sexo, required, required String? idade, bool docil = false}) : super(sexo, idade,docil) {
 ...
 // super neste caso refere-se ao construtor da super instância que no casgito é Mamifero()
  void acao() {
